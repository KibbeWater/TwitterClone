...
function RegisterModal({ switchMode }: AuthProps) {
...
function LoginModal({ switchMode }: AuthProps) {
	const [username, setUsername] = useState('');
	const [password, setPassword] = useState('');
...
export default function UserAuth({ mode, switchMode }: Props) {
	...
	switch (mode) {
		case 'SignIn':
			content = <LoginModal switchMode={switchMode} />;
			break;
		case 'SignUp':
			content = <RegisterModal switchMode={switchMode} />;
			break;
	}
