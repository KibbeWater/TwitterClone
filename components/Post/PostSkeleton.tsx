export default function PostSkeleton() {
	return (
		<div className={`p-3 mb-px w-full max-w-full relative bg-transparent border-b-[1px] flex animate-pulse`}>
			...
			<div className={'pl-3 w-full flex flex-col overflow-hidden'}>
				<div className={'max-w-full w-full pr-9 flex-nowrap flex overflow-hidden items-center mb-2'}>
					<div className={'mr-[5px] w-3/12 h-[1em] bg-gray-500 rounded-lg'} />
					<div className={'ml-[2px] h-[1em] w-2/12 bg-gray-500 rounded-lg'} />
